...
<main class="app-content">
    <div class="app-title">
        <div>
            <h1><i class="fa fa-window-close-o"></i> 故障管理</h1>
            <p>故障列表</p>
        </div>
        <ul class="app-breadcrumb breadcrumb">
            <li class="breadcrumb-item"><i class="fa fa-window-close-o"></i></li>
            <li class="breadcrumb-item"><a href="#">故障管理</a></li>
        </ul>
    </div>
    <div class="row">
        <div class="col-md-12">
            <div class="tile">
                <div class="tile-body">
                    <table class="table table-hover table-bordered" id="sampleTable">
                        ...
                        <tbody>
                        <c:forEach items="${faultRecords}" var="fr" varStatus="status">
                            <tr>
                                <td>${fr.appEui}</td>
                                <td>${fr.devEui}</td>
