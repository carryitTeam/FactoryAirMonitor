...
<section class="login-content">
    ...
    <div class="login-box">
        <form class="login-form" action="checkUser" method="post" onsubmit="return checkData();">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="password" placeholder="Password" name="userPwd"
                       id="userPassword">
            </div>
            <div class="form-group">
                <div class="utility">
                    ...
                    <p class="semibold-text mb-2"><a href="#" data-toggle="flip">Forgot Password
                        ?</a></p>
                </div>
            </div>
        ...
        <form class="forget-form" action="index.index.jsp">
            ...
            <div class="form-group btn-container">
                <button class="btn btn-primary btn-block"><i class="fa fa-unlock fa-lg fa-fw"></i>RESET
                </button>
            </div>
